...
func main() {
	// Обработчик для обслуживания только index.html
	...
	log.Println("Сервер запущен на :20059")
	log.Fatal(http.ListenAndServe(":20059", nil))
}

// Обработчик для обслуживания только index.html
func serveIndex(w http.ResponseWriter, r *http.Request) {
	http.ServeFile(w, r, "./site_c/index.html")
}
...
// Проверка допустимого расширения изображения
